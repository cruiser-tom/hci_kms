...
if 'experiment_group' not in st.session_state:
    st.session_state.experiment_group = 'Open' # Change to 'Open' to test the other UI

# --- 3. UI FUNCTIONS ---
from google.api_core.exceptions import ResourceExhausted

# ... [Keep your SYSTEM_CONTEXT and other setup exactly the same] ...
